...
<div style='width:150px;' >
   <div style='border:1px solid #000000;padding:2px;width:100%;font-size:80%;font-weight:bold;'>
      <img src='style/counter.gif' width='16' height='16' border='0' /> Visitor Statistics
   </div>

   <div style='border:1px solid #000000;padding:2px;width:100%;font-size:80%;'>
      &raquo; $online Online<br />   
      &raquo; $day Today<br />
      &raquo; $yesterday Yesterday<br />
      &raquo; $week Week<br />
      &raquo; $month Month<br />
      &raquo; $year Year<br />
      &raquo; $all Total   
   </div>

   <div style='border:1px solid #000000;padding:2px;width:100%;font-size:80%;'>
      Record: $record (" . date("02/08/2021", $record_time) .")
